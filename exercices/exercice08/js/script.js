...
function gotGeocodeData (data) {
 ...
 $("#pWhereYouFrom").text("Oh you're from " + city + "! Your life must be exhausting... Why don't you treat yourself a little and go to a nearby spa center? (look at your popup filter if the page is not opening)");
  window.open("https://www.google.ca/search?q=spa+" + city + "&oq=spa+montreal&aqs=chrome.0.69i59j0l5.2759j0j7&sourceid=chrome&ie=UTF-8", "newwindow", "width = 400, height = 400, bottom=250, left = 250", "_blank");
}
